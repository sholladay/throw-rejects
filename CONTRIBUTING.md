...
**Important work** comes in many forms. There are labels for [bugs](https://github.com/sholladay/throw-rejects/labels/bug) and [easy](https://github.com/sholladay/throw-rejects/labels/easy) vs [hard](https://github.com/sholladay/throw-rejects/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
